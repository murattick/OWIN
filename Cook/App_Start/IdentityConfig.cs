...
namespace Cook
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            var client = new SmtpClient
            {
                Host = "mailtrap.io",
                Port = 2525,
                Credentials = new NetworkCredential("ffafabd2825c42", "68e39d96a2b9e7"),
                EnableSsl = true,
                Timeout = 20000,
        };

            var @from = new MailAddress("Cook@info.com", "Ваш сайт Cook");
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            //string AccountSid = "AC4072acf401d759d003a5dd0b11154868";
